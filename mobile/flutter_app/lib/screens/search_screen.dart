    ...
    try {
                ...
                Container(
                  ...
                  child: IconButton(
                    icon: Icon(Icons.tune,
                        color:
                            _showFilters ? Colors.white : Colors.grey.shade700),
                    onPressed: () =>
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      Row(children: [
                        ...
                        const SizedBox(width: 8),
                        const Expanded(
                            child: Text('Sadece Ücretsiz Etkinlikler',
                                style: TextStyle(fontWeight: FontWeight.w500))),
                        Switch(
                            value: _onlyFree,
                            activeThumbColor: const Color(0xFF6366F1),
                            onChanged: (v) => setState(() => _onlyFree = v)),
                      ]),
                      if (!_onlyFree) ...[
                        const SizedBox(height: 8),
                        Row(
      ...
      return Padding(
        ...
        child: ReusableBanner(
          ...
          subtitle:
              'Sayfayı yenilemeyi deneyin veya bize bildirin: example@gmail.com',
          actionLabel: 'Yenile',
          onAction: () => setState(() {}),
        ),
      );
